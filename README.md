...
## Inputs
Contains a snakemake pipeline that takes a .fastq file as input (e.g. your raw sequencing data) and runs through several assembly and quality checking steps. 
